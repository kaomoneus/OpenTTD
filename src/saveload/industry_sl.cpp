...
static const SaveLoad _industry_desc[] = {
	...
	SLE_CONDARR(Industry, incoming_cargo_waiting,     SLE_FILE_U16 | SLE_VAR_U32,  3,              SLV_70, SLV_EXTEND_INDUSTRY_CARGO_SLOTS),
	SLE_CONDARR(Industry, incoming_cargo_waiting, SLE_FILE_U16 | SLE_VAR_U32, 16, SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SLV_STEPAN),
	SLE_CONDARR(Industry, incoming_cargo_waiting, SLE_UINT32, 16, SLV_STEPAN, SL_MAX_VERSION),
	SLE_CONDARR(Industry, produced_cargo_waiting,     SLE_FILE_U16 | SLE_VAR_U32,  2,               SL_MIN_VERSION, SLV_EXTEND_INDUSTRY_CARGO_SLOTS),
	SLE_CONDARR(Industry, produced_cargo_waiting, SLE_FILE_U16 | SLE_VAR_U32, 16, SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SLV_STEPAN),
	SLE_CONDARR(Industry, produced_cargo_waiting, SLE_UINT32, 16, SLV_STEPAN, SL_MAX_VERSION),
	SLE_CONDARR(Industry, production_rate,            SLE_FILE_U8 | SLE_VAR_U16,   2,               SL_MIN_VERSION, SLV_EXTEND_INDUSTRY_CARGO_SLOTS),
	SLE_CONDARR(Industry, production_rate, SLE_FILE_U8 | SLE_VAR_U16, 16, SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SLV_STEPAN),
	SLE_CONDARR(Industry, production_rate, SLE_UINT16, 16, SLV_STEPAN, SL_MAX_VERSION),
	...
	SLE_CONDARR(Industry, this_month_production, SLE_FILE_U16 | SLE_VAR_U32, 16, SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SLV_STEPAN),
	SLE_CONDARR(Industry, this_month_production, SLE_UINT32, 16, SLV_STEPAN, SL_MAX_VERSION),
	SLE_CONDARR(Industry, this_month_transported,     SLE_FILE_U16 | SLE_VAR_U32,  2,               SL_MIN_VERSION, SLV_EXTEND_INDUSTRY_CARGO_SLOTS),
	SLE_CONDARR(Industry, this_month_transported, SLE_FILE_U16 | SLE_VAR_U32, 16, SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SLV_STEPAN),
	SLE_CONDARR(Industry, this_month_transported, SLE_UINT32, 16, SLV_STEPAN, SL_MAX_VERSION),
	...
	SLE_CONDARR(Industry, last_month_production, SLE_FILE_U16 | SLE_VAR_U32, 16, SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SLV_STEPAN),
	SLE_CONDARR(Industry, last_month_production, SLE_UINT32, 16, SLV_STEPAN, SL_MAX_VERSION),
	SLE_CONDARR(Industry, last_month_transported,     SLE_FILE_U16 | SLE_VAR_U32,  2,               SL_MIN_VERSION, SLV_EXTEND_INDUSTRY_CARGO_SLOTS),
	SLE_CONDARR(Industry, last_month_transported, SLE_FILE_U16 | SLE_VAR_U32, 16, SLV_EXTEND_INDUSTRY_CARGO_SLOTS, SLV_STEPAN),
	SLE_CONDARR(Industry, last_month_transported, SLE_UINT32, 16, SLV_STEPAN, SL_MAX_VERSION),
    SLE_CONDVAR(Industry, counter,                SLE_FILE_U16 | SLE_VAR_U32, SL_MIN_VERSION, SLV_STEPAN),
    SLE_CONDVAR(Industry, counter,                    SLE_UINT32, SLV_STEPAN, SL_MAX_VERSION),
