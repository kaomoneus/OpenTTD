...
static const SaveLoad _date_desc[] = {
	...
	SLEG_CONDVAR("date",                   _date,                   SLE_INT32,                  SLV_31, SL_MAX_VERSION),
	    ...
	    SLEG_CONDVAR("tick_counter",         _tick_counter,           SLE_FILE_U16 | SLE_VAR_U32, SL_MIN_VERSION, SLV_STEPAN),
	    SLEG_CONDVAR("tick_counter",         _tick_counter,           SLE_UINT32, SLV_STEPAN, SL_MAX_VERSION),
