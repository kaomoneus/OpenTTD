...
static const SaveLoad _old_station_desc[] = {
	...
	SLE_CONDVAR(Station, had_vehicle_of_type,        SLE_UINT8,                 SLV_122, SL_MAX_VERSION),
	    ...
	    SLE_CONDVAR(Station, delete_ctr,             SLE_FILE_U8 | SLE_VAR_U16, SL_MIN_VERSION, SLV_STEPAN),
	    SLE_CONDVAR(Station, delete_ctr,             SLE_UINT16, SLV_STEPAN, SL_MAX_VERSION),
...
public:
	inline static const SaveLoad description[] = {
		   ...
		   SLE_SSTR(BaseStation, name,                   SLE_STR | SLF_ALLOW_CONTROL),
            SLE_CONDVAR(BaseStation, delete_ctr,             SLE_FILE_U8 | SLE_VAR_U16, SL_MIN_VERSION, SLV_STEPAN),
            SLE_CONDVAR(BaseStation, delete_ctr,             SLE_UINT16, SLV_STEPAN, SL_MAX_VERSION),
